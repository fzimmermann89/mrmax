...
import torch
from mrmax.operators.models.EPG import DelayBlock, EPGSequence, FispBlock, InversionBlock, Parameters, T2PrepBlock
...
class CardiacFingerprinting(SignalModel[torch.Tensor, torch.Tensor, torch.Tensor]):
    ...
    extended phase graph (`~mrmax.operators.models.EPG`) formalism.
    ...
    .. note::
       ...
       `~mrmax.operators.SignalModel` based on this implementation if you need to simulate a different sequence.
