...
from mrmax.algorithms.reconstruction.RegularizedIterativeSENSEReconstruction import (
...
class IterativeSENSEReconstruction(RegularizedIterativeSENSEReconstruction):
    ...
    def __init__(
        ...
        *,
        ...
        please see `~mrmax.algorithms.reconstruction.RegularizedIterativeSENSEReconstruction`.
