...
import pytest
import torch
from mrmax.operators import ElementaryFunctional, ElementaryProximableFunctional, ProximableFunctional
from mrmax.operators.Functional import ScaledFunctional, ScaledProximableFunctional
