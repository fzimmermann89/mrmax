...
import pytest
import torch
from mrmax.operators.Functional import ElementaryFunctional, ElementaryProximableFunctional
from mrmax.operators.functionals import MSE, L1Norm, L1NormViewAsReal, L2NormSquared, ZeroFunctional
