"""PyTest fixtures for the mrmax package."""
...
from mrmax.data import AcqIdx, AcqInfo, KData, KHeader, KTrajectory, SpatialDimension
from mrmax.data.enums import AcqFlags
from mrmax.utils.reshape import unsqueeze_tensors_left
...
def ismrmrd_cart_high_res(ellipse_phantom, tmp_path_factory):
    """Fully sampled cartesian data set."""
    ismrmrd_filename = tmp_path_factory.mktemp('mrmax') / 'ismrmrd_cart_high_res.h5'
    ismrmrd_kdata = IsmrmrdRawTestData(
        filename=ismrmrd_filename,
        matrix_size=256,
        noise_level=0.0,
