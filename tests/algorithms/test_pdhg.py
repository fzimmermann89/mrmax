...
import pytest
import torch
from mrmax.algorithms.optimizers import pdhg
from mrmax.operators import FastFourierOp, IdentityOp, LinearOperatorMatrix, ProximableFunctionalSeparableSum, WaveletOp
from mrmax.operators.functionals import L1Norm, L1NormViewAsReal, L2NormSquared, ZeroFunctional
