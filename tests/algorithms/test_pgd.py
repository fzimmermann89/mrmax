...
import pytest
import torch
from mrmax.algorithms.optimizers import pgd
from mrmax.data.SpatialDimension import SpatialDimension
from mrmax.operators import FastFourierOp, LinearOperatorMatrix, ProximableFunctionalSeparableSum, WaveletOp
from mrmax.operators.functionals import L1NormViewAsReal, L2NormSquared
from mrmax.phantoms import EllipsePhantom
