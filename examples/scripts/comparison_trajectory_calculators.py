...
# Passing an instance of `~mrmax.data.traj_calculators.KTrajectoryIsmrmrd` to
# when loading the data tells the `~mrmax.data.KData` object to use the trajectory
...
# `~mrmax.data.traj_calculators.KTrajectoryCalculator`.
# ```
...
kdata = mrmax.data.KData.from_file(
    data_folder / 'radial2D_402spokes_golden_angle_with_traj.h5',
    mrmax.data.traj_calculators.KTrajectoryRadial2D(golden_angle),
)
...
kdata = mrmax.data.KData.from_file(
    data_folder / 'radial2D_402spokes_golden_angle_with_traj.h5',
    mrmax.data.traj_calculators.KTrajectoryPulseq(seq_path),
)
