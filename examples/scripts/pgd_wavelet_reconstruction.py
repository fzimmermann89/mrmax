...
wavelet_operator = mrmax.operators.WaveletOp(
...
l2 = 0.5 * mrmax.operators.functionals.L2NormSquared(target=kdata_24spokes.data, divide_by_n=False)
l1 = mrmax.operators.functionals.L1NormViewAsReal(divide_by_n=False)
...
# and stepsize update
from mrmax.algorithms.optimizers.pgd import PGDStatus
...
(img_wave_pgd_24,) = mrmax.algorithms.optimizers.pgd(
    f=f,
    g=g,
